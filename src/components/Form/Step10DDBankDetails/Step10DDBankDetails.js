...
const Step10DDBankDetails = ({setCurrentStep, formRef}) => {
  const [errorState, errorDispatch] = useContext(
      FormErrorContext); // Get the error state of form data from
  ...
  accept instructions to pay Direct Debits.<
      ...
      <li>If an error is made in the payment of your Direct Debit,
      by West
  ...
  bank or building society<
      ...
      <li>You can cancel a Direct Debit at any time by simply contacting your
  bank or building society.Written confirmation may be required.Please
  also notify us.</li>
      </ul><fieldset className = "wmnds-fe-fieldset">
      <legend className = "wmnds-fe-fieldset__legend">
      <h3 className = "wmnds-fe-question">Bank or building society account
          details</h3>
        </legend>
  ...
  inputmode =
      "numeric" / >
      <p>Please pay West Midlands Combined Authority Direct Debits from the
